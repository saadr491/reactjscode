...
<div>
        ...
        <div id="mobile-filter">
          ...
          <div className="py-2 border-bottom ml-3">
            ...
            <form>
              <div className="form-group"> <input type="checkbox" id="artisan" /> <label htmlFor="artisan">Cruiser Bike</label></div>
              <div className="form-group"> <input type="checkbox" id="breakfast" /> <label htmlFor="breakfast">Sports Bike</label></div>
              <div className="form-group"> <input type="checkbox" id="healthy" /> <label htmlFor="healthy">Adventure Bike</label></div>
              <div className="form-group"> <input type="checkbox" id="healthy" /> <label htmlFor="healthy">Cafe Racer Bike</label></div>
            </form>
          </div>
          <div className="py-2 border-bottom ml-3">
          ...
          <div className="py-2 border-bottom ml-3">
            ...
            <div id="orange"><span className="fa fa-minus" /></div>
            <form>
            <div className="form-group"> <input type="checkbox" id="tea" /> <label htmlFor="tea">Yamaha Ybr</label> </div>
              <div className="form-group"> <input type="checkbox" id="cookies" /> <label htmlFor="cookies">Kawasaki </label> </div>
              <div className="form-group"> <input type="checkbox" id="pastries" /> <label htmlFor="pastries">Suzuki 125 cc</label> </div>
              <div className="form-group"> <input type="checkbox" id="dough" /> <label htmlFor="dough">Atlas Honda </label> </div>
              <div className="form-group"> <input type="checkbox" id="choco" /> <label htmlFor="choco">Hellcat Bike</label> </div>
             <a href="#">   View more   </a>
            </form>
          </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'220px'}} className="card-img-top" src="https://www.atlashonda.com.pk/wp-content/themes/twentyfourteen/assets/img/product-range/bike8-4.png" />
                  <div className="card-body">
                    <h5><b>Atlas Honda bike</b> </h5>
              ...
              <br />
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'220px'}} className="card-img-top" src="https://www.drivespark.com/images/2020-07/2020-bmw-s-1000-xr-30.jpg" />
                  <div className="card-body">
                    <h5><b>BMW Bike C-190</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'220px'}} className="card-img-top" src="https://assets.newatlas.com/dims4/default/26920f4/2147483647/strip/true/crop/675x450+38+0/resize/1200x800!/quality/90/?url=http%3A%2F%2Fnewatlas-brightspot.s3.amazonaws.com%2Farchive%2Fconfederate-x132-hellcat-speedster.jpg" />
                  <div className="card-body">
                    <h5><b>Hellcat Bike X-132</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'220px'}} className="card-img-top" src="https://i.pinimg.com/originals/7d/d8/ca/7dd8caa339a9536d5d099b2a44318e69.jpg" />
                  <div className="card-body">
                    <h5><b>Kawasaki Heavy Bike</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'220px'}} className="card-img-top" src="https://static.pakwheels.com/2016/04/honda-cg125.jpg" />
                  <div className="card-body">
                    <h5><b>Suzuki CG-125 Bike</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'220px'}} className="card-img-top" src="https://i.ytimg.com/vi/7pZWDunCjFA/maxresdefault.jpg" />
                  <div className="card-body">
                    <h5><b>Yamaha Ybr 125</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'280px'}} className="card-img-top" src="https://lh3.googleusercontent.com/proxy/qJTT606lBeyEMxNRuzbcEeFzNLITAocHPjpuwJOspG__pLSuQSzJpuLNptEqtjiayuRYtTr6ogxmi0fKO5ME7DJQ2mfNq8lAzo3wPRIKDr-kmw2nI82zoPRldg" />
                  <div className="card-body">
                    <h5><b>Suzuki 125 cc</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'280px'}} className="card-img-top" src="https://bd.gaadicdn.com/processedimages/piaggio/piaggio-vespa-125/source/piaggio-vespa-1255ed09ba4a5485.jpg?tr=w-360" />
                  <div className="card-body">
                    <h5><b>Vespa LX 125</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
              ...
              <br/>
              <div className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div className="card"> <img style={{height:'280px'}} className="card-img-top" src="https://cdp.azureedge.net/products/USA/KA/2020/MC/SUPERSPORT/NINJA_H2/50/MIRROR_COATED_SPARK_BLACK/2000000018.jpg" />
                  <div className="card-body">
                    <h5><b>Kawasaki Ninja 2020 H2</b> </h5>
                    <div className="d-flex flex-row my-2">
                      <div className="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
